...
const memories = [
  {
    ...
    images: [
      { url: '/public/1dec19.jpg', caption: 'Service with fam ❤.' },
      { url: '/public/6dec19pt2.jpg', caption: 'Christmas Wonderland with ❤.' },
      { url: '/public/8dec19.jpg', caption: 'At Jimboi house for phototaking w fam ❤.' },
      { url: '/public/15dec19.jpg', caption: 'Christmas Candlelight service with fam ❤.' },
      { url: '/public/28dec19.jpg', caption: '1st Monthsary with Shawnie pt 1 ❤.' },
      { url: '/public/28dec19pt2.jpg', caption: '1st Monthsary with Shawnie pt 2 ❤.' },
    ],
  },
  {
    title: '2020 Memories',
  ...
  },
  {
    ...
    images: [
      { url: '/public/31may24.jpg', caption: 'Our first pict as a married couple ❤.' },
      { url: '/public/31may24pt2.jpg', caption: 'Dancing the night away with maternal fam ❤.' },
      { url: '/public/31may24pt3.jpg', caption: 'Dancing the night away with Shawnie fam ❤.' },
      { url: '/public/31may24pt4.jpg', caption: 'Dancing the night away with both Shawnie and mine ❤.' },
      { url: '/public/31may24pt5.jpg', caption: 'Picture with the car as wedded hubs and wifey ❤' },
      { url: '/public/31may24pt6.jpg', caption: 'ROM picture with maternal fam ❤.' },
      { url: '/public/31may24pt7.jpg', caption: 'Dancing the night away with Shawnie fam pt 2 ❤.' },
      { url: '/public/31may24pt8.jpg', caption: 'ROM picture with Shawnie fam ❤.' },
    ],
  },
];
